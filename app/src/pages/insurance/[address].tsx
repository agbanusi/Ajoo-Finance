...
import { fetchAnInsuranceCircle } from "../../api/insuranceCircle";
...
const InsurancePoolPage: React.FC = () => {
  ...
  const {
    data: mockInsurancePool,
    isLoading,
    error,
  } = useQuery({
    queryKey: ["AnInsuranceCircle", poolId],
    queryFn: () => fetchAnInsuranceCircle(poolId + ""),
  });
  ...
  return (
    <div className="p-8">
      ...
      <Card className="mb-6">
        ...
        <p>
          Next Contribution Deadline: {mockInsurancePool?.contributionPeriod}
        </p>
